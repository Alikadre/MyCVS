...
public class dispvoter extends JFrame implements ActionListener
{
	JLabel l1,l2,l3,v_id,v_name,v_phno,v_done;
	JTextField v_idtf,v_nametf,v_phnotf;
	JButton search,reset,back,exit;
	Choice done;
	Cursor cur;
	...
	public dispvoter()
	{
		...
		getContentPane().setBackground(new Color(14,200,19));
		setLayout(null); 
